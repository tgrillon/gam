...
Mesh::Mesh(const GLenum primitives, const std::vector<vec3> &positions) : m_positions(), m_texcoords(), m_normals(), m_colors(), m_indices(),
...
Mesh::Mesh(const GLenum primitives, const std::vector<vec3> &positions, const std::vector<unsigned> &indices) : m_positions(), m_texcoords(), m_normals(), m_colors(), m_indices(),
                                                                                                                m_color(White()), m_primitives(GL_POINTS), m_vao(0), m_buffer(0), m_index_buffer(0), m_vertex_buffer_size(0), m_index_buffer_size(0), m_update_buffers(false)
{
    m_primitives = primitives;
    m_positions = positions;
...
Mesh::Mesh(const GLenum primitives, const std::vector<vec3> &positions,
           ...
           const std::vector<unsigned> &indices) : m_positions(), m_texcoords(), m_normals(), m_colors(), m_indices(),
                                                   m_color(White()), m_primitives(GL_POINTS), m_vao(0), m_buffer(0), m_index_buffer(0), m_vertex_buffer_size(0), m_index_buffer_size(0), m_update_buffers(false)
{
    m_primitives = primitives;
    m_positions = positions;
